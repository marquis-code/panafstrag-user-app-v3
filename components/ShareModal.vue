        ...
        <div class="p-6">
          <div class="grid grid-cols-4 gap-4 mb-6">
            <button @click="shareWhatsApp" class="flex flex-col items-center gap-2 group">
              ...
              <span class="text-sm font-medium text-gray-600 group-hover:text-gray-900">{{ t('WhatsApp') }}</span>
            </button>
            ...
            <button @click="shareTwitter" class="flex flex-col items-center gap-2 group">
              ...
              <span class="text-sm font-medium text-gray-600 group-hover:text-gray-900">{{ t('X (Twitter)') }}</span>
            </button>
            ...
            <button @click="shareLinkedIn" class="flex flex-col items-center gap-2 group">
              ...
              <span class="text-sm font-medium text-gray-600 group-hover:text-gray-900">{{ t('LinkedIn') }}</span>
            </button>
            ...
            <button @click="shareFacebook" class="flex flex-col items-center gap-2 group">
              ...
              <span class="text-sm font-medium text-gray-600 group-hover:text-gray-900">{{ t('Facebook') }}</span>
            </button>
          </div>
